...
main () {
  ...
  /* Creating the bible object calls this */
  ...
  while (1){
	...
	textFile.seekg (position, ios::beg); //Position the input stream to this offset in the file. Equivilent to textfile.seekg(position);
